...
public class AssignFacilityUseCase implements UseCaseForCommand<AssignFacilityCommand> {

    private final EventsRepository eventsRepository;

    public AssignFacilityUseCase(EventsRepository eventsRepository) {this.eventsRepository = eventsRepository;}
    @Override
    public List<DomainEvent> apply(AssignFacilityCommand command) {
        ...
        booking.AssignAFacility(command.getFacilityId());
